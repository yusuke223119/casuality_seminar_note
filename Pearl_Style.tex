...
\begin{proof}
  ...
  さて、$F_x$ から $Y$ へのパスは $X$ を通るパスのみである。$X, Y$ のバックドアパスを含む場合、$Z$ によって、そうでない場合は $X$ で条件をつけることで、$F_x$ と $Y$ を有向分離できるため、定理3.6より、
  \begin{equation}
    F_x \perp Y \mid X, Z
  \end{equation}
  が成り立つ。ため、
